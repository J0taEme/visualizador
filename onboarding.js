(function () {
        ...
        passos = [
            {
                ...
                texto: "Este é o gráfico de barras: cada barra representa um número do vetor sendo ordenado, e a altura dela mostra o valor. As cores indicam o que está acontecendo em cada momento — veja a legenda no topo do painel (comparando, trocando, ordenado, pivô/mínimo)."
            },
            {
                alvo: sidebar,
                texto: "Esta é a barra lateral de questões: enquanto o algoritmo roda, perguntas aparecem aqui pra testar seu entendimento, junto com o histórico de acertos e erros. Use o botão redondo na borda pra abrir e fechar quando quiser.",
                aoEntrar: () => {
            ...
            },
            {
                ...
                texto: "Aqui você escolhe qual algoritmo visualizar: Bubble, Selection, Insertion, Merge ou Quick Sort. Trocar de algoritmo reaproveita o vetor atual — só a forma de ordenar muda."
            },
            {
                alvo: document.getElementById("grupoInputVetor"),
                texto: "E aqui você personaliza o vetor: digite números separados por vírgula ou espaço (ex: 5,3,8,1) para ordenar exatamente esses valores, ou apenas um número para gerar um vetor aleatório com esse tamanho. Deixe em branco e clique em 'Gerar' pra um vetor aleatório de 8 elementos."
            }
        ];
    }
    ...
    function mostrarPasso(indice) {
        ...
        btnTutorialProx.textContent = (passoAtual === passos.length - 1) ? "Concluir" : "Próximo ▶";
    }
    ...
    function posicionarSpot(alvo) {
        ...
        esquerda = Math.min(Math.max(16, esquerda), window.innerWidth - tutorialCaixa.offsetWidth - 16);
